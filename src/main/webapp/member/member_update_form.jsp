    ...
    <div class="container" style="margin-top: 100px">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <form action="./member" method="post" id="updateFrm" name="updateFrm" class="form-horizontal">
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="userId">ID </label>
                        <div class="col-sm-8">
                            <input type="text" id="userId" name="userId" class="form-control" placeholder="ID" disabled value='${vo.userId}'>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="password" id="passwordConfirm" name="passwordConfirm" class="form-control" placeholder="비밀번호 확인">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="email" name="email" class="form-control" placeholder="메일" value="${vo.email}">
                        </div>
                    </div>
