...
<head>
    ...
    <script src="/webjars/summernote/0.8.8/lang/summernote-ko-KR.js"></script>
            ...
            <div class="panel-body">
                ...
                <form action="./board" method="post" id="postFrm" name="updateFrm" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="subject" name="subject" class="form-control" placeholder="제목" value="<%=dto.getSubject()%>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="writer">작성자</label>
                        <div class="col-sm-8">
                            <input type="text" id="writer" name="writer" class="form-control" placeholder="작성자" value="<%= dto.getWriter()%>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea rows="15" id="summernote" name="content" class="form-control" placeholder="내용" value="<%= dto.getContent()%>"> </textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="submit" value="수정완료" id="returnBtn" class="btn btn-primary" style="float: right"/>
