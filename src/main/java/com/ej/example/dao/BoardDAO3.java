...
import com.ej.example.datasource.BoardConnectionManager3;
...
public class BoardDAO3 extends BoardConnectionManager3 implements DAOSupport<BoardDTO> {
    ...
    public BoardDTO selectOne(final int seq) throws SQLException {
        ...
        return dtoList.size() > 0 ? dtoList.get(0) : null;
    }
    ...
    public int insert(final BoardDTO dto) throws SQLException {
        ...
        return executeUpdate(query, dto.getWriter(),
                dto.getPassword(),
                dto.getSubject(),
                dto.getContent());
    }
    ...
    public int update(final BoardDTO dto) throws SQLException {
        ...
        return executeUpdate(query,
                ...
                dto.getSubject(),
                dto.getContent(),
                new SimpleDateFormat("yyyy-MM-dd HH:hh:mm").format(new java.util.Date()),
                dto.getSeq());
    }
